# https://github.com/oguzhan-yilmaz/pyCrossfade/blob/master/pycrossfade/song.py

# Copyright (c) 2020 Oğuzhan Yılmaz
# 
...
class Song():
    ...
    def load_song_audio(self):
        self.audio = Song.load_audio(self.filepath)
    ...
    def load_beats(self):
        ...
        annotation_beats_path = Song.path_to_annotation_file("music_swap_annotations", self.song_name)
